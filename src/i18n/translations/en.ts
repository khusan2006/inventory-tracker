const enTranslation = {
  ...
  debt: {
    addToDebtBook: "Add to Debt Book",
    switchToSale: "Switch to Sale",
    debtSummary: "Debt Summary",
    debtInformation: "Debt Information",
    customerName: "Customer Name",
    customerNamePlaceholder: "Enter customer name",
    notes: "Notes",
    notesPlaceholder: "Add notes about this debt...",
    recordDebt: "Record Debt",
    debtsManagement: "Debts Management",
    trackAndManageDebts: "Track and manage all debt transactions",
    ...
    noDebtsYet: "No debts have been recorded yet",
    noDebtsWithStatus: "No {{status}} debts found",
    failedToLoadDebts: "Failed to load debts",
    pendingDebtsExist: "There are pending debts that must be resolved before rollover",
    debtsPreventsRollover: "Monthly rollover cannot proceed while there are unpaid debts",
    debtRecordedSuccess: "Debt recorded successfully!",
    failedToRecordDebt: "Failed to record debt. Please try again.",
    debtCreatedForCustomer: "Debt created for {{customer}}",
    debtCreatedAnonymously: "Debt created successfully",
    debtStatusUpdated: "Debt status updated successfully",
    debtDeleted: "Debt record deleted successfully",
    failedToUpdateDebt: "Failed to update debt",
    failedToDeleteDebt: "Failed to delete debt"
  },
